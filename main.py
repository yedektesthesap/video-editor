...
class MainWindow(QMainWindow):
    ...
    def _build_event_tab(self, container: QWidget) -> None:
        ...
        table_section = QWidget(right_panel)
        ...
        table_section_layout.addWidget(self.event_table, stretch=1)

        self.event_table_actions_row = QWidget(table_section)
        self.event_table_actions_row.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Fixed)
        event_table_actions_layout = QHBoxLayout(self.event_table_actions_row)
        ...
        table_section_layout.addWidget(self.event_table_actions_row)
        ...
        upper_layout.addWidget(table_section, stretch=1)
