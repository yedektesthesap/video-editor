...
class MainWindow(QMainWindow):
    ...
    def _update_analysis_controls(self) -> None:
        ...
        self.color_roi_label.setVisible(False)
        self.color_roi_combo.setVisible(False)
        self.color_analyze_button.setVisible(False)
        self.color_progress.setVisible(False)
        self.roi_color_timeline.setVisible(False)
